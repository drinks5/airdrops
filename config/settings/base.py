...
USE_TZ = True
PROXY_SERVER = env.json("PROXY_SERVER")
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = 'telegramcloud.users.adapters.AccountAdapter'
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = 'telegramcloud.users.adapters.SocialAccountAdapter'
